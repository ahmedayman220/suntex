    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_he') ? 'is-invalid' : '' }}" type="text" name="name_he" id="name_he" value="{{ old('name_he', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_he') ? 'is-invalid' : '' }}" name="description_he" id="description_he">{!! old('description_he') !!}</textarea>
