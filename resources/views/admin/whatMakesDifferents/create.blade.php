...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.whatMakesDifferent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.what-makes-differents.store") }}" enctype="multipart/form-data">
            @csrf
