...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.aboutUsSection.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.about-us-sections.update", [$aboutUsSection->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.aboutUsSection.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $aboutUsSection->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $aboutUsSection->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ceo_name') ? 'is-invalid' : '' }}" type="text" name="ceo_name" id="ceo_name" value="{{ old('ceo_name', $aboutUsSection->ceo_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('ceo_description') ? 'is-invalid' : '' }}" name="ceo_description" id="ceo_description">{!! old('ceo_description', $aboutUsSection->ceo_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('lang_code') ? 'is-invalid' : '' }}" name="lang_code" id="lang_code" required>
                    ...
                    @foreach(App\Models\AboutUsSection::LANG_CODE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('lang_code', $aboutUsSection->lang_code) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
