            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductTag">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.productTag.fields.lang_code') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\ProductTag::LANG_CODE_SELECT as $key => $item)
                ...
                <tbody>
                    @foreach($productTags as $key => $productTag)
                        <tr data-entry-id="{{ $productTag->id }}">
                            ...
                            <td>
                                {{ App\Models\ProductTag::LANG_CODE_SELECT[$productTag->lang_code] ?? '' }}
                            </td>
                            <td>
