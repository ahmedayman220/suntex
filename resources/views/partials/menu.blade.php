<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('section_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/about-us-sections*") ? "c-show" : "" }} {{ request()->is("admin/about-us-features*") ? "c-show" : "" }} {{ request()->is("admin/sliders*") ? "c-show" : "" }} {{ request()->is("admin/faqs*") ? "c-show" : "" }} {{ request()->is("admin/what-makes-differents*") ? "c-show" : "" }} {{ request()->is("admin/subscribes*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('about_us_section_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.about-us-sections.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/about-us-sections") || request()->is("admin/about-us-sections/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.aboutUsSection.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('about_us_feature_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.about-us-features.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/about-us-features") || request()->is("admin/about-us-features/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.aboutUsFeature.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('slider_access')
                    ...
                    @endcan
                    @can('what_makes_different_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.what-makes-differents.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/what-makes-differents") || request()->is("admin/what-makes-differents/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.whatMakesDifferent.title') }}
                            </a>
                        </li>
                    @endcan
