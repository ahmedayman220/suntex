...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::delete('what-makes-differents/destroy', 'WhatMakesDifferentController@massDestroy')->name('what-makes-differents.massDestroy');
    Route::resource('what-makes-differents', 'WhatMakesDifferentController');
    ...
    Route::post('subscribes/parse-csv-import', 'SubscribeController@parseCsvImport')->name('subscribes.parseCsvImport');
    Route::post('subscribes/process-csv-import', 'SubscribeController@processCsvImport')->name('subscribes.processCsvImport');
